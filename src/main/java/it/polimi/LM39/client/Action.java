...
public enum Action {
	...
	CLI (new String[]{"PRINT MAINBOARD","PRINT MARKET","PRINT COUNCIL","PRINT HARVEST AND PRODUCTION","PRINT POSSESED CARDS","SHOW MENU",
	"PRINT DICES VALUES","PRINT RANKINGS","GET INFO"});
